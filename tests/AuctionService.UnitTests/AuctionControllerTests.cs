...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        _controller = new AuctionsController(_mapper, _publishEndpoint.Object, _auctionRepository.Object)
        {
    ...
    [Fact]
    public async Task CreateAuction_WithValidCreatedAuctionDto_ReturnsCreatedAtAction()
    {
        // arrange
